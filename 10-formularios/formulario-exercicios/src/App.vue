    ...
    <div class="conteudo">
      <form class="painel">
        ...
        <Rotulo nome="Características do Problema">
          <span class="mr-4">
            <input type="checkbox" v-model="características" value="reproduzivel"> Reproduzível
          </span>
          <span>
            <input type="checkbox" v-model="características" value="intermitente"> Intermitente
          </span>
        </Rotulo>
      ...
      <div class="painel">
        ...
        <Rotulo nome="Marque as Opções">
          <span>
            <ul>
              <li v-for="c in  características" :key="c">{{ c }}</li>
              <li></li>
            </ul>
          </span>
        </Rotulo>
